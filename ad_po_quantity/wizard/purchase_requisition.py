...
#from purchase_requisition.wizard import purchase_requisition_partner
...
class purchase_requisition_partner(osv.osv_memory):
    ...
    def create_order(self, cr, uid, ids, context=None):
        #print "this is from ad_analytic_purchase"
        """
        ...
        if record_ids:
            ...
            for tender in tender_obj.browse(cr, uid, record_ids, context=context):
                ...
                purchase_id = order_obj.create(cr, uid, {
                            ...
                            #'contact_supplier': partner_id,
                            #'project_id_dummy':tender.project_id.id,
                })
                print "========================"
                order_ids=[]
