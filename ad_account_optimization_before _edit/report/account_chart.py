...
report_sxw.report_sxw('report.ad.account.account.chart.report', 'account.account','addons/ad_account_optimization/report/account_chart.rml', parser=account_chart, header=False)
