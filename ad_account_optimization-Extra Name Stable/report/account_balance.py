...
report_sxw.report_sxw('report.account.balance.full', 'account.account', 'addons/ad_account_optimization/report/account_balance_full.rml', parser=account_balance, header=False)
report_sxw.report_sxw('report.account.balance.full.currency', 'account.account', 'addons/ad_account_optimization/report/account_balance_full_currency.rml', parser=account_balance, header=False)
#report_sxw.report_sxw('report.account.trial.balance.pt', 'account.account', 'addons/ad_account_optimization/report/account_trial_balance_pt.rml', parser=account_balance, header="internal")
