...
from ad_account_optimization.report.account_general_ledger import general_ledger
import cStringIO
        ...
        if data['form']['currency_rate'] == 1:
            ...
            cols_specs = [
                ...
                ('Ref.', 1, 60, 'text',
                    lambda x, d, p: x['lref']),
                ('Move', 1, 60, 'text',
                    lambda x, d, p: x['mmove_name_manual'] or x['move']),
                ...
                ('Currency Amount', 1, 90, 'number',
                    lambda x, d, p: parser._currency_rate(x['lid'],c.currency_id.id)),
                ('Symbol', 1, 30, 'text',
                    lambda x, d, p: parser._currency_id(x['lid'],c.currency_id.id)),
                ('Account Name Extra', 1, 90, 'text',
                    lambda x, d, p: x['laccount_name']),
            ...
            hdr_line = ['Date', 'Period', 'JNRL', 'Partner Name', 'Ref.', 'Move', 'Entry Label', 'Debit', 'Credit', 'Balance', 'Currency Amount', 'Symbol', 'Account Name Extra']
            hdr_account_total = ['Account Code', 'Account Name', 'Account Debit', 'Account Credit', 'Account Balance', 'Account Currency']
            ...
            row_hdr_style = xlwt.easyxf('pattern: pattern solid, fore_color gray25;')
            ...
            self.xls_write_row(ws, None, data, parser, 4, row_hdr5, blank_style)
            ...
            hdr_line = ['Date', 'Period', 'JNRL', 'Partner Name', 'Ref.', 'Move', 'Entry Label', 'Debit', 'Credit', 'Balance', 'Account Name Extra']
...
account_balance_report_xls(
        'report.account.general.ledget_landscape.xls',
        'account.account',
