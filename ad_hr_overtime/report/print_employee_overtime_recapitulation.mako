	...
	<body>
		%for o in get_object(data):
			...
			%for e in o.employee:
				...
				%endif
						<tr>
							<td class="center"><h2>DAFTAR LEMBUR KARYAWAN BUMI SIAK PUSAKO<h2></td>
						</tr>
						<tr>
						%if o.filter == 'date':
							<td class="center">Periode: ${get_periode(o.date)}</td>
						%else:
							<td class="center">Periode: ${get_periode(o.periode.date_start)}</td>
						%endif
						</tr>
						<tr>
						...
						<tr>
							<td width="100%"><br/><br/><br/>
								...
								<% nomor=1 %>
								%for ot_data in get_overtime(e.id, o.filter, o.date, o.periode.id):
										...
										%if is_holiday(ot.time_start):
											...
											%else:
												%if ot.duration<=9:
													<% dur_hol_x4 = 0.0 %>
												%else:
													<% dur_hol_x4 = ot.duration - 9 %>
													%if dur_hol_x4>0:
														<% dur_hol_x4=dur_hol_x4 %>
													%else:
														<% dur_hol_x4=0 %>
													%endif
												%endif
						...
						%if get_dept().manager_id:
							<tr>
								<td class="nama"><u>LINA</u></td>
							</tr>
							<tr>
								<td class="center">Staf Legal</td>
							</tr>
						%else:
							<tr>
								<td class="nama"><u>LINA</u></td>
