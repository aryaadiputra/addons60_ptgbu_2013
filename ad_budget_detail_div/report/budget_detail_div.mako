	...
	%if len(get_department(data))>0:
		%for d in get_department(data):
			<table width="100% cellpadding="3" class="break">
				<tr>
					<td colspan="16"><h2>Department : ${d.name}</h2></td>
				</tr>
				<tr class ="head_table">
						...
						%if i['balance']:
							%if i['type'] == 'view':
								...
								<tr ${bold}>
									...
									<td align="left" style="font-size:10px;font-color:white;"><span style="font-color:#000000;font-size:10px;"></span><span style="font-size:10px;">${ i['name'] }</span></td>
									<td colspan="14" align="right" style="font-size:10px;"></td>	
								</tr>
							...
							<tr ${bold}>
								<td align="center" style="font-size:10px;">${no}</td>
								<td align="left" style="font-size:10px;font-color:white;"><span style="font-color:#000000;font-size:10px;"></span><span style="font-size:10px;">${subno}      ${ i['name'] }</span></td>
							...
							<tr ${bold}>
								...
								<td class="body_total_with_under_line" align="center" style="font-size:10px;"> ${ formatLang(total_actual,digits=get_digits(dp='Budget')) or 0.0}</td>
							...
							<tr>
								<td align="center" style="font-size:14px;"></td>
								<td class="actual_trans" align="left" colspan="14"><u>Actual</u></td>
							...
							%if data['form']['with_transaction'] and i['type'] == 'normal':
								%for t in get_transaction(data['form']['as_of_date'],i['id'], d['id']):
									<tr ${bold}>
										<td align="center" style="font-size:14px;"></td>
										<td class="actual_trans" align="left" style="font-size:10px;">- ${t.name}</td>
							...
							%endif
							<tr>
								<td colspan="16" align="center" style="font-size:10px;">&nbsp;</td>
							</tr>
							<tr>
								<td align="center" style="font-size:14px;"></td>
								<td class="actual_trans" align="left" colspan="14"><u>Budget (unutilized)</u></td>
								<td class="body_total" align="center" style="font-size:14px;"></td>
							</tr>
							
							<tr ${bold}>
								<td align="center" style="font-size:14px;"></td>
								<td class="actual_trans" align="left" style="font-size:10px;">- ${ get_desc_budget_line(data['form']['as_of_date'],data['form']['1']['id'], i['id'], data['form']['1']['start'], data['form']['1']['end'], i['type'], i['item'], d['id'])}</td>
								<td align="right" style="font-size:10px;"></td>
								
								<!--********************-->
								<%unutulized_1 = get_period_unutilized(data['form']['as_of_date'],data['form']['1']['id'], i['id'], data['form']['1']['start'], data['form']['1']['end'], i['type'], i['item'], d['id'])%>
								<%unutulized_2 = get_period_unutilized(data['form']['as_of_date'],data['form']['2']['id'], i['id'], data['form']['2']['start'], data['form']['1']['end'], i['type'], i['item'], d['id'])%>
								<%unutulized_3 = get_period_unutilized(data['form']['as_of_date'],data['form']['3']['id'], i['id'], data['form']['3']['start'], data['form']['1']['end'], i['type'], i['item'], d['id'])%>
								<%unutulized_4 = get_period_unutilized(data['form']['as_of_date'],data['form']['4']['id'], i['id'], data['form']['4']['start'], data['form']['1']['end'], i['type'], i['item'], d['id'])%>
								<%unutulized_5 = get_period_unutilized(data['form']['as_of_date'],data['form']['5']['id'], i['id'], data['form']['5']['start'], data['form']['1']['end'], i['type'], i['item'], d['id'])%>
								<%unutulized_6 = get_period_unutilized(data['form']['as_of_date'],data['form']['6']['id'], i['id'], data['form']['6']['start'], data['form']['1']['end'], i['type'], i['item'], d['id'])%>
								<%unutulized_7 = get_period_unutilized(data['form']['as_of_date'],data['form']['7']['id'], i['id'], data['form']['7']['start'], data['form']['1']['end'], i['type'], i['item'], d['id'])%>
								<%unutulized_8 = get_period_unutilized(data['form']['as_of_date'],data['form']['8']['id'], i['id'], data['form']['8']['start'], data['form']['1']['end'], i['type'], i['item'], d['id'])%>
								<%unutulized_9 = get_period_unutilized(data['form']['as_of_date'],data['form']['9']['id'], i['id'], data['form']['9']['start'], data['form']['1']['end'], i['type'], i['item'], d['id'])%>
								<%unutulized_10 = get_period_unutilized(data['form']['as_of_date'],data['form']['10']['id'], i['id'], data['form']['10']['start'], data['form']['1']['end'], i['type'], i['item'], d['id'])%>
								<%unutulized_11 = get_period_unutilized(data['form']['as_of_date'],data['form']['11']['id'], i['id'], data['form']['11']['start'], data['form']['1']['end'], i['type'], i['item'], d['id'])%>
								<%unutulized_12 = get_period_unutilized(data['form']['as_of_date'],data['form']['12']['id'], i['id'], data['form']['12']['start'], data['form']['1']['end'], i['type'], i['item'], d['id'])%>
								<!--********************-->
				...
				%if data['form']['without_zero']:
					%if i['balance']:
						...
						<!-- ########################Actual######################## -->
							...
							<tr>
								<td align="center" style="font-size:16px; padding-top=50px "></td>
							</tr>
							<!-- ###################################################### -->
							<!-- ########################Under/ Over######################## -->
							<tr ${bold}>
							...
							<tr ${bold}>
								<td align="center" style="font-size:14px;"></td>
								<td class="actual_trans" align="left" style="font-size:10px;">- ${ get_desc_budget_line(data['form']['as_of_date'],data['form']['1']['id'], i['id'], data['form']['1']['start'], data['form']['1']['end'], i['type'], i['item'])}</td>
								<td align="right" style="font-size:10px;"></td>
