...
from ad_budget_detail_div.report.budget_detail_div import budget_detail_div
import cStringIO
from tools.translate import _
from xlwt import Workbook, Formula

class budget_detail_div_xls(report_xls):
...
budget_detail_div_xls(
        'report.budget.detail.div.xls',
        'ad_budget.item',
        'addons/ad_budget_detail_div/report/budget_detail_div.mako',
        parser=budget_detail_div,
        header=False)
