...
class budget_rolling(osv.osv_memory):
    _name = "budget.rolling.report.div"
    _columns = {
...
#            ],'Group By', required=True)
        ...
        'department_select'     : fields.many2many('hr.division', 'wizard_dept_rel', 'division_id', 'wizard_id', 'Division',),
    }
...
#        'groupby': lambda *a: 'none',
    ...
    def create_budget_rolling(self, cr, uid, ids, context=None):
        ...
        datas['model'] = 'budget.rolling.report.div'
...
#            }
        ...
        if datas['form']['type'] == 'pdf':
            ...
            return { 
                'type': 'ir.actions.report.xml',
                'report_name': 'budget.rolling.div.xls',
                'report_type': 'webkit',
                'datas': datas,
            }
