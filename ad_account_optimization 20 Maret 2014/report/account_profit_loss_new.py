...
class report_pl_account_horizontal_new(report_sxw.rml_parse, common_report_header):

    def __init__(self, cr, uid, name, context=None):
        super(report_pl_account_horizontal_new, self).__init__(cr, uid, name, context=context)
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return super(report_pl_account_horizontal_new, self).set_context(objects, data, new_ids, report_type=report_type)
    ...
    def get_lines_another(self, group):
        #print "xxxxxxxxxxxxxxxxxxx", self.result.get(group, [])
...
#    'addons/ad_account_optimization/report/account_profit_currency.rml',parser=report_pl_account_horizontal_new, header='internal landscape')

report_sxw.report_sxw('report.ad.pl.account.new', 'account.account',
    'addons/ad_account_optimization/report/account_profit_loss_new.mako',parser=report_pl_account_horizontal_new, header='internal')
