...
class budget_detail_div(osv.osv_memory):
    _name = "budget.detail.div.report"
    _columns = {
...
#            ],'Group By', required=True)
        ...
        'department_select'     : fields.many2many('hr.division', 'wizard_dept_rel', 'department_id', 'wizard_id', 'Department', ),
...
#        'groupby': lambda *a: 'none',
    ...
    def create_budget_detail(self, cr, uid, ids, context=None):
        ...
        datas['model'] = 'budget.detail.div.report'
...
#            }
        ...
        if datas['form']['type'] == 'pdf':
            return { 
                ...
                'report_name': 'budget.detail.div.pdf',
                'report_type': 'webkit',
                'datas': datas,
            }
        else:    
            return { 
                'type': 'ir.actions.report.xml',
                'report_name': 'budget.detail.div.xls',
                'report_type': 'webkit',
                'datas': datas,
            }
