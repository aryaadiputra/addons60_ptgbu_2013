...
class wiz_budget_per_department(wizard.interface):
    ...
    def _build_form(self, cr, uid, data, context):
        ...
        arch.string = _form_header + _form_footer
    ...
    states = {
        ...
        'print' : {
            ...
            'result' : {'type':'print', 'report':'budget_vs_actual', 'get_id_from_action':True, 'state':'end'},
        },
    }
    
wiz_budget_per_department('budget.per.department')
