...
from ad_account_optimization.report.account_trial_balance_cur import account_balance
    ...
    def generate_xls_report(self, parser, data, obj, wb):
        ...
        if data['form']['currency_rate'] == 1:
            ...
            row_balance = self.xls_row_template(cols_specs,
                    ['Code','Account','Debit','Credit','Balance','Balance IDR'])
...
account_balance_report_xls(
        ...
        header=False)
"""account_balance_report_xls(
        'report.account.trial.balance.pt',
        'account.account',
        'addons/ad_account_optimization/report/account_trial_balance_pt.rml',
        parser=account_balance,
        header=False)
account_balance_report_xls(
        'report.account.trial.balance.currency.pt',
        'account.account',
        'addons/ad_account_optimization/report/account_trial_balance_currency_pt.rml',
        parser=account_balance,
        header=False)"""
