...
class ad_budget_version(osv.osv):
    ...
    def get_periods (self, cr, uid, version, context={}):
        ...
        budget_obj = self.pool.get('ad_budget')        
    ...
    def get_filtered_budget_values(self, cr,uid, version, lines, \
        ...
        period_start is a ad_budget.period object
        period_end is a ad_budget.period object
        ...
        budget_lines_obj = pooler.get_pool(cr.dbname).get('ad_budget.line')        
    ...
    def unlink(self, cr, uid, ids, context={}):
        ...
        return super(ad_budget_version, self).unlink(cr, uid, ids, context)
