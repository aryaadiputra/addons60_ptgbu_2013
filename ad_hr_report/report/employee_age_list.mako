...
<center id="reportname" height="60 px">
	<h3 class="reportname">Employee List by Age</h3>
</center
<br height="30px;"/>
<% 
datalist=data['form']
...
<table border="1" bordercolor="lightGrey" cellpadding="3" cellspacing="0" style="page-break-after:always;">
	<tr style="page-break-inside:avoid; page-break-after:auto;">
		...
		<td class="tabhead agel">Age</td>
	</tr>
	<%count+=33%>
	%for age in get_age():
		<% no=1 %>
		<tr style="page-break-inside:avoid; page-break-after:auto;">
			<td colspan="9" class="group">Age : ${age['name']}</td>
		</tr>
		<%count+=21%>
		<% employees=get_employee(datalist['active'],datalist['filter_dept'],datalist['filter_sect'],dummy,dummy,dummy,age['value'],dummy,'age ASC')%>
		%if employees>0:
			%for emp in employees:
				<tr style="page-break-inside:avoid; page-break-after:auto;">
					...
					<td class="data age">${emp.age or "<center>N/A</center>"}</td>
				</tr>
				<% 
				count+=33
				no+=1
