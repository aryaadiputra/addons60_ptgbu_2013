...
class employee_list(report_sxw.rml_parse):


    def __init__(self, cr, uid, name, context):
        super(employee_list, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.print.employee.list', 'hr.employee', 'ad_hr_bsp/report/employee_list.mako', parser=employee_list)
