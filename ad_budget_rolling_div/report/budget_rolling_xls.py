...
from ad_budget_rolling_div.report.budget_rolling import budget_rolling_div
import cStringIO
...
class budget_rolling_xls(report_xls):
    ...
    def generate_xls_report(self, parser, data, obj, wb):
        ...
        cols_specs = [
                ...
                ####################ARYA#####################
                #Month Total CAPEX
                ('TotalCAPEXDepDesc', 8, 0, 'text', lambda x, d, p: "TOTAL CAPITAL COST"),
                ('MtotCAPEXDep1', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['1']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], capexD, False, dep['id'])),
                ('MtotCAPEXDep2', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['2']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], capexD, False, dep['id'])),
                ('MtotCAPEXDep3', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['3']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], capexD, False, dep['id'])),
                ('MtotCAPEXDep4', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['4']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], capexD, False, dep['id'])),
                ('MtotCAPEXDep5', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['5']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], capexD, False, dep['id'])),
                ('MtotCAPEXDep6', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['6']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], capexD, False, dep['id'])),
                ('MtotCAPEXDep7', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['7']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], capexD, False, dep['id'])),
                ('MtotCAPEXDep8', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['8']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], capexD, False, dep['id'])),
                ('MtotCAPEXDep9', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['9']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], capexD, False, dep['id'])),
                ('MtotCAPEXDep10', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['10']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], capexD, False, dep['id'])),
                ('MtotCAPEXDep11', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['11']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], capexD, False, dep['id'])),
                ('MtotCAPEXDep12', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['12']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], capexD, False, dep['id'])),
                ('TotalCAPEXDep',    1, 270, 'number', lambda x, d, p: parser.get_total_row_Total(data['form']['as_of'], data['form']['fiscalyear_id'], capexD, False, dep['id'])),
                ('BudgetCAPEXDep',   1, 270, 'number', lambda x, d, p: parser.get_total_row_Budget(data['form']['as_of'], data['form']['fiscalyear_id'], capexD, False, dep['id'])),
                ('VarianceCAPEXDep', 1, 270, 'number', lambda x, d, p: (parser.get_total_row_Budget(data['form']['as_of'], data['form']['fiscalyear_id'], capexD, False, dep['id']))-(parser.get_total_row_Total(data['form']['as_of'], data['form']['fiscalyear_id'], capexD, False, dep['id']))),
                
                #Month Total COGS Department
#                ('TotalCOGSDepDesc', 8, 0, 'text', lambda x, d, p: "TOTAL CAPITAL COST"),
#                ('MtotCOGSDep1', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['1']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
#                ('MtotCOGSDep2', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['2']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
#                ('MtotCOGSDep3', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['3']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
#                ('MtotCOGSDep4', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['4']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
#                ('MtotCOGSDep5', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['5']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
#                ('MtotCOGSDep6', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['6']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
#                ('MtotCOGSDep7', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['7']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
#                ('MtotCOGSDep8', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['8']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
#                ('MtotCOGSDep9', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['9']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
#                ('MtotCOGSDep10', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['10']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
#                ('MtotCOGSDep11', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['11']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
#                ('MtotCOGSDep12', 1, 0, 'number', lambda x, d, p: parser.get_total_row_capex(data['form']['12']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
#                ('TotalCOGSDep',    1, 270, 'number', lambda x, d, p: parser.get_total_row_Total(data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
#                ('BudgetCOGSDep',   1, 270, 'number', lambda x, d, p: parser.get_total_row_Budget(data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
#                ('VarianceCOGSDep', 1, 270, 'number', lambda x, d, p: (parser.get_total_row_Budget(data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id']))-(parser.get_total_row_Total(data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id']))),
#                
                ...
                ('MtotCOGS1', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['1']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogs, False, False)),
                ('MtotCOGS2', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['2']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogs, False, False)),
                ('MtotCOGS3', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['3']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogs, False, False)),
                ('MtotCOGS4', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['4']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogs, False, False)),
                ('MtotCOGS5', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['5']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogs, False, False)),
                ('MtotCOGS6', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['6']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogs, False, False)),
                ('MtotCOGS7', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['7']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogs, False, False)),
                ('MtotCOGS8', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['8']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogs, False, False)),
                ('MtotCOGS9', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['9']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogs, False, False)),
                ('MtotCOGS10', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['10']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogs, False, False)),
                ('MtotCOGS11', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['11']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogs, False, False)),
                ('MtotCOGS12', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['12']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogs, False, False)),
                ('TotalCOGS',    1, 270, 'number', lambda x, d, p: parser.get_total_row_Total(data['form']['as_of'], data['form']['fiscalyear_id'], cogs, False, False)),
                ('BudgetCOGS',   1, 270, 'number', lambda x, d, p: parser.get_total_row_Budget(data['form']['as_of'], data['form']['fiscalyear_id'], cogs, False, False)),
                ('VarianceCOGS', 1, 270, 'number', lambda x, d, p: (parser.get_total_row_Budget(data['form']['as_of'], data['form']['fiscalyear_id'], cogs, False, False))-(parser.get_total_row_Total(data['form']['as_of'], data['form']['fiscalyear_id'], cogs, False, False))),
                #Month Total Expense
                ('TotalExpense', 8, 0, 'text', lambda x, d, p: "TOTAL OPERATING EXPENSES"),
                ('MtotEXP1', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['1']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], exps, False, False)),
                ('MtotEXP2', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['2']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], exps, False, False)),
                ('MtotEXP3', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['3']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], exps, False, False)),
                ('MtotEXP4', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['4']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], exps, False, False)),
                ('MtotEXP5', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['5']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], exps, False, False)),
                ('MtotEXP6', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['6']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], exps, False, False)),
                ('MtotEXP7', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['7']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], exps, False, False)),
                ('MtotEXP8', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['8']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], exps, False, False)),
                ('MtotEXP9', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['9']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], exps, False, False)),
                ('MtotEXP10', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['10']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], exps, False, False)),
                ('MtotEXP11', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['11']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], exps, False, False)),
                ('MtotEXP12', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['12']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], exps, False, False)),
                ('TotalEXP',    1, 270, 'number', lambda x, d, p: parser.get_total_row_Total(data['form']['as_of'], data['form']['fiscalyear_id'], exps, False, False)),
                ('BudgetEXP',   1, 270, 'number', lambda x, d, p: parser.get_total_row_Budget(data['form']['as_of'], data['form']['fiscalyear_id'], exps, False, False)),
                ('VarianceEXP', 1, 270, 'number', lambda x, d, p: (parser.get_total_row_Budget(data['form']['as_of'], data['form']['fiscalyear_id'], exps, False, False))-(parser.get_total_row_Total(data['form']['as_of'], data['form']['fiscalyear_id'], exps, False, False))),
                #Month Total COGS Department
                ('TotalCOGSDepDesc', 8, 0, 'text', lambda x, d, p: "TOTAL PRODUCTION COST"),
                ('MtotCOGSDep1', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['1']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
                ('MtotCOGSDep2', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['2']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
                ('MtotCOGSDep3', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['3']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
                ('MtotCOGSDep4', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['4']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
                ('MtotCOGSDep5', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['5']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
                ('MtotCOGSDep6', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['6']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
                ('MtotCOGSDep7', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['7']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
                ('MtotCOGSDep8', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['8']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
                ('MtotCOGSDep9', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['9']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
                ('MtotCOGSDep10', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['10']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
                ('MtotCOGSDep11', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['11']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
                ('MtotCOGSDep12', 1, 0, 'number', lambda x, d, p: parser.get_total_row_cogs(data['form']['12']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
                ('TotalCOGSDep',    1, 270, 'number', lambda x, d, p: parser.get_total_row_Total(data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
                ('BudgetCOGSDep',   1, 270, 'number', lambda x, d, p: parser.get_total_row_Budget(data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id'])),
                ('VarianceCOGSDep', 1, 270, 'number', lambda x, d, p: (parser.get_total_row_Budget(data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id']))-(parser.get_total_row_Total(data['form']['as_of'], data['form']['fiscalyear_id'], cogsD, False, dep['id']))),
                #Month Total Expense Department
                ('TotalExpenseDep', 8, 0, 'text', lambda x, d, p: "TOTAL OPERATING EXPENSES"),
                ('MtotEXPDep1', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['1']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], expsD, False, dep['id'])),
                ('MtotEXPDep2', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['2']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], expsD, False, dep['id'])),
                ('MtotEXPDep3', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['3']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], expsD, False, dep['id'])),
                ('MtotEXPDep4', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['4']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], expsD, False, dep['id'])),
                ('MtotEXPDep5', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['5']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], expsD, False, dep['id'])),
                ('MtotEXPDep6', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['6']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], expsD, False, dep['id'])),
                ('MtotEXPDep7', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['7']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], expsD, False, dep['id'])),
                ('MtotEXPDep8', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['8']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], expsD, False, dep['id'])),
                ('MtotEXPDep9', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['9']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], expsD, False, dep['id'])),
                ('MtotEXPDep10', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['10']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], expsD, False, dep['id'])),
                ('MtotEXPDep11', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['11']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], expsD, False, dep['id'])),
                ('MtotEXPDep12', 1, 0, 'number', lambda x, d, p: parser.get_total_row_expense(data['form']['12']['id'], data['form']['as_of'], data['form']['fiscalyear_id'], expsD, False, dep['id'])),
                ('TotalEXPDep',    1, 270, 'number', lambda x, d, p: parser.get_total_row_Total(data['form']['as_of'], data['form']['fiscalyear_id'], expsD, False, dep['id'])),
                ('BudgetEXPDep',   1, 270, 'number', lambda x, d, p: parser.get_total_row_Budget(data['form']['as_of'], data['form']['fiscalyear_id'], expsD, False, dep['id'])),
                ('VarianceEXPDep', 1, 270, 'number', lambda x, d, p: (parser.get_total_row_Budget(data['form']['as_of'], data['form']['fiscalyear_id'], expsD, False, dep['id']))-(parser.get_total_row_Total(data['form']['as_of'], data['form']['fiscalyear_id'], expsD, False, dep['id']))),
...
#
        ...
        tittle_style = xlwt.easyxf('font: height 180,name Arial, colour_index white, bold on; pattern: pattern solid, fore_color white;')
...
#        self.xls_write_row(ws, None, data, parser, 5, row_hdr2, tittle_style)
        ...
        print "_______________________________ROW 10"
        row_count = 10
...
budget_rolling_xls(
        'report.budget.rolling.div.xls',
        'ad_budget.item',
        'addons/ad_budget_rolling_div/report/budget_rolling.mako',
        parser=budget_rolling_div,
        header=False)
