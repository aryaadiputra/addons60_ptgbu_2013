...
from ad_account_optimization.report.account_chart import account_chart
import cStringIO
...
class account_chart_xls(report_xls):
    ...
    def generate_xls_report(self, parser, data, obj, wb):
        ...
        tittle_style = xlwt.easyxf('font: height 400, name Arial Black, colour_index blue, bold on; align: wrap on, vert centre, horiz center; pattern: pattern solid, fore_color gray25;')
