...
class eagle_contract( osv.osv ):
	...
	_columns = {
		'current_sale_order': fields.one2many( 'sale.order', 'contract_id', 'Current Sale Order', domain=[('state','=','draft')] ),
		'past_sale_order': fields.one2many( 'sale.order', 'contract_id', 'Past Sale Order', domain=[('state','<>','draft')] ),
