...
class account_balance_report_xls(report_xls):
    ...
    def generate_xls_report(self, parser, data, obj, wb):
        ...
        if data['form']['currency_rate'] == 1:
            ...
            hdr_line = ['Date', 'Period', 'JNRL', 'Partner Name', 'Ref.', 'Move', 'Entry Label', 'Debit', 'Credit', 'Balance', 'Currency Amount', 'Symbol']
            ...
            hdr_line = ['Date', 'Period', 'JNRL', 'Partner Name', 'Ref.', 'Move', 'Entry Label', 'Debit', 'Credit', 'Balance']
