            ...
            for account in accounts:
                if (account.user_type.report_type) and (account.user_type.report_type == typ):
                    account_dict = {
                        ...
                        'balance_dual': account.balance_dual,
                    }
            ...
            for i in range(0,max(len(cal_list['liability']),len(cal_list['asset']))):
                if i < len(cal_list['liability']) and i < len(cal_list['asset']):
                    temp={
                          ...
                          'balance_dual':cal_list['liability'][i]['balance_dual'],
                          ...
                          'balance_dual1':cal_list['asset'][i]['balance_dual'],
                          }
...
report_sxw.report_sxw('report.ad.account.balancesheet.currency', 'account.account',
    'addons/ad_account_optimization/report/account_balance_sheet_currency.rml',parser=report_balancesheet_horizontal,
    header='internal landscape')

report_sxw.report_sxw('report.ad.account.balancesheet', 'account.account',
    'addons/ad_account_optimization/report/account_balance_sheet.rml',parser=report_balancesheet_horizontal,
    header='internal')
