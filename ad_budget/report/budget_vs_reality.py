    ...
    def get_story(self):
        ...
        for v in versions: 
            ...
            for aa in aa_groups:
                ...
                table.add_text_column(self._('Structure'), 110*mm)
...
budget_vs_reality('report.budget_vs_reality2', "Budget Vs. Actual5", 'ad_budget.line', StandardReport.A4_PORTRAIT)        
