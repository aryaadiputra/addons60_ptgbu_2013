...
_fields = {
    ...
    'items': {'string':'Budget Items', 'type':'many2many', 'relation':'ad_budget.item'},
}
...
class wiz_advanced_search(wizard.interface):
    ...
    def _get_budget_lines(self, cr, uid, data, context):
        ...
        item_obj = pooler.get_pool(cr.dbname).get('ad_budget.item')
...
wiz_advanced_search('budget.advanced_search2')