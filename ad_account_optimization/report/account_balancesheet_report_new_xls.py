...
from ad_account_optimization.report.account_balance_sheet_new import report_balancesheet_horizontal_new
import cStringIO
...
#                    lambda x, d, p: 'xxxx3'),
        ...
        initial_date            = c['result_initial_date']
...
#            row_count += 1          
        ...
        for a in parser.get_lines_another('asset'):
            if a['level'] == 2:
...
#                    row_count += 1
        ...
        for a in parser.get_lines_another('liability'):
            if a['level'] == 3:
                style = row_italic_style
            else:
                style = row_normal_style
...
account_balance_report_new_xls(
        ...
        parser=report_balancesheet_horizontal_new,
        header=False)
