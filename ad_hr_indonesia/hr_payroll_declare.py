...
class hr_payroll_declar(osv.osv):
    ...
    _columns = {
        ...
        'income_sal': fields.float('Income by Salary', digits_compute= dp.get_precision('Account'), readonly=True),
        ...
        'income': fields.float('Taxable Income', digits_compute= dp.get_precision('Account'), readonly=True),
        'investment': fields.float('Total Investment', digits_compute= dp.get_precision('Account'), readonly=True),
        'claims': fields.float('Total Allowance Claims', digits_compute= dp.get_precision('Account'), readonly=True),
...
class hr_payroll_declare_line(osv.osv):
    ...
    _columns = {
        ...
        'allow': fields.float('Allowence', digits_compute= dp.get_precision('Account')),
        'allow_amount': fields.function(_function_call, method=True, type='float', digits_compute= dp.get_precision('Account'), string='Allow Amount'),
...
class payment_category(osv.osv):
    ...
    _columns = {
        ...
        'min': fields.float('Min Value', digits_compute= dp.get_precision('Account')),
        'max': fields.float('Max Value', digits_compute= dp.get_precision('Account')),
