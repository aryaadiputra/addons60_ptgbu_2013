...
class wiz_budget_consolidation(wizard.interface):
    ...
    _fields = {
        'versions': {'string':'Versions', 'type':'many2many', 'relation':'ad_budget.version', 'required':True },
    ...
    states = {
        ...
        'print' : {
            ...
            'result' : {'type':'print', 'report':'budget_consolidation2', 'get_id_from_action':True, 'state':'end'},
        },

    }
    
    
wiz_budget_consolidation('budget.consolidation2')