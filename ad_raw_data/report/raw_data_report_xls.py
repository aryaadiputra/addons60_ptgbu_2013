...
class account_raw_data_report_xls(report_xls):
    ...
    def generate_xls_report(self, parser, data, obj, wb):
        ...
        cols_specs = [
                ...
                ('Label Parent Account2', 1, 0, 'text',
                    lambda x, d, p: 'Parent COA 2'),
                ('Label Parent Account1', 1, 0, 'text',
                    lambda x, d, p: 'Parent COA 1'),
                ...
                ('Label Parent Analytic Code Name2', 1, 0, 'text',
                    lambda x, d, p: 'Parent Analytic COA2'),
                ('Label Parent Analytic Code Name1', 1, 0, 'text',
                    lambda x, d, p: 'Parent Analytic COA1'),
                ...
                ('Data Parent Account2', 1, 0, 'text',
                    lambda x, d, p: x['parent_account2']),
                ('Data Parent Account1', 1, 0, 'text',
                    lambda x, d, p: x['parent_account1']),
                ...
                ('Data Parent Analytic Code Name2', 1, 0, 'text',
                    lambda x, d, p: x['parent_analytic_code_name2']),
                ('Data Parent Analytic Code Name1', 1, 0, 'text',
                    lambda x, d, p: x['parent_analytic_code_name1']),
                ...
                ('Data Status', 1, 0, 'text',
                    lambda x, d, p: x['data_status']),
                ...
                ('Data Parent Account Budget2', 1, 0, 'text',
                    lambda x, d, p: x['parent_account_budget2']),
                ('Data Parent Account Budget1', 1, 0, 'text',
                    lambda x, d, p: x['parent_account_budget1']),
                ...
                ('Data Parent Analytic Code Name Budget2', 1, 0, 'text',
                    lambda x, d, p: x['parent_analytic_code_name_budget2']),
                ('Data Parent Analytic Code Name Budget1', 1, 0, 'text',
                    lambda x, d, p: x['parent_analytic_code_name_budget1']),
...
#                    lambda x, d, p: 'xxxx3'),
        ...
        label_data = self.xls_row_template(cols_specs, [
                                                        ...
                                                        'Label DigitCOA',
                                                        'Label Parent Account2',
                                                        'Label Parent Account1',
                                                        'Label Parent Account',
                                                        'Label Account',
                                                        
                                                        'Label DigitAnalytic',
                                                        'Label Parent Analytic Code Name2',
                                                        'Label Parent Analytic Code Name1',
        ...
        row_data = self.xls_row_template(cols_specs, [
                                                      'Data Division',
                                                        ...
                                                        'Data DigitCOA',
                                                        'Data Parent Account2',
                                                        'Data Parent Account1',
                                                        'Data Parent Account',
                                                        'Data Account',
                                                        
                                                        'Data DigitAnalytic',
                                                        'Data Parent Analytic Code Name2',
                                                        'Data Parent Analytic Code Name1',
...
#                                                        'Data Budget12',
        ...
        row_data_budget = self.xls_row_template(cols_specs, [
                                                        ...
                                                        'Data Parent Account Budget2',
                                                        'Data Parent Account Budget1',
                                                        'Data Parent Account Budget',
                                                        'Data Account Budget',
                                                        
                                                        'Data DigitAnalytic Budget',
                                                        'Data Parent Analytic Code Name Budget2',
                                                        'Data Parent Analytic Code Name Budget1',
...
#        
        ...
        for move_line in parser._get_move_line(data):
            ...
            parent_account1     = ""
            parent_account2     = ""
            if move_line.account_id.parent_id:
                parent_account1 = move_line.account_id.parent_id.parent_id.code +" - "+ move_line.account_id.parent_id.parent_id.name
            if parent_account1 <> "":
                parent_account2 = move_line.account_id.parent_id.parent_id.parent_id.code +" - "+ move_line.account_id.parent_id.parent_id.parent_id.name
            ...
            parent_analytic_code_name1      = ""
            parent_analytic_code_name2      = ""
            digit_analytic          = ""
            analytic_coa_code       = ""
            if move_line.analytic_account_id:
                ...
                if move_line.analytic_account_id.parent_id.parent_id:
                    #print "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR", move_line.analytic_account_id.parent_id.parent_id.parent_id.code
                    parent_analytic_code_name1       = re.split(' ',move_line.analytic_account_id.parent_id.parent_id.code)[1] +" - "+move_line.analytic_account_id.parent_id.parent_id.name
                #if move_line.analytic_account_id.parent_id.parent_id.parent_id:
                #   parent_analytic_code_name2       = re.split(' ',move_line.analytic_account_id.parent_id.parent_id.parent_id.code)[1] +" - "+move_line.analytic_account_id.parent_id.parent_id.parent_id.name
                if parent_analytic_code_name1 != "":
                    try :
                        parent_analytic_code_name2 = re.split(' ',move_line.analytic_account_id.parent_id.parent_id.parent_id.code)[1] +" - "+move_line.analytic_account_id.parent_id.parent_id.parent_id.name
                    except:
                        parent_analytic_code_name2 = move_line.analytic_account_id.parent_id.parent_id.parent_id.code +" - "+move_line.analytic_account_id.parent_id.parent_id.parent_id.name
            ...
            #print date, date01['start_month'], date, date01['end_month']
            ...
            self.xls_write_row(ws, {
                                    ...
                                    'period'            : period,
                                    'ref'               : ref,
                                    'parent_account2'   : parent_account2,
                                    'parent_account1'   : parent_account1, 
                                    ...
                                    'parent_analytic_code_name2' : parent_analytic_code_name2,
                                    'parent_analytic_code_name1' : parent_analytic_code_name1,
        ...
        for budget_line in parser._get_budget_line(data):
            ...
            ref_budget                 = ""
            parent_account_budget1     = ""
            parent_account_budget2     = ""
            
            parent_account_budget      = budget_line.budget_item_id.parent_id.code +" - "+ budget_line.budget_item_id.parent_id.name
            if budget_line.budget_item_id.parent_id.parent_id:
                parent_account_budget1     = budget_line.budget_item_id.parent_id.parent_id.code +" - "+ budget_line.budget_item_id.parent_id.parent_id.name
            
            if budget_line.budget_item_id.parent_id.parent_id.parent_id:
                parent_account_budget2     = budget_line.budget_item_id.parent_id.parent_id.parent_id.code +" - "+ budget_line.budget_item_id.parent_id.parent_id.parent_id.name
            ...
            parent_analytic_code_name_budget1 = ""
            parent_analytic_code_name_budget2 = ""
            ...
            if budget_line.analytic_account_id.parent_id.parent_id:
                parent_analytic_code_name_budget1 = re.split(' ',budget_line.analytic_account_id.parent_id.parent_id.code)[1] +" - "+budget_line.analytic_account_id.parent_id.parent_id.name
            
            if parent_analytic_code_name_budget1 != "":
                try :
                    parent_analytic_code_name_budget2 = re.split(' ',budget_line.analytic_account_id.parent_id.parent_id.parent_id.code)[1] +" - "+budget_line.analytic_account_id.parent_id.parent_id.parent_id.name
                except:
                    parent_analytic_code_name_budget2 = budget_line.analytic_account_id.parent_id.parent_id.parent_id.code +" - "+budget_line.analytic_account_id.parent_id.parent_id.parent_id.name
            ...
            if budget_line.period_id.id in get_range_periods:
                ...
                #budget_ytd_budget = parser._get_budget_ytd(budget_line.analytic_account_id.id,get_range_periods)
            ...
            self.xls_write_row(ws, {
                                    ...
                                    'parent_account_budget2'   : parent_account_budget2,
                                    'parent_account_budget1'   : parent_account_budget1,
                                    ...
                                    'parent_analytic_code_name_budget1' : parent_analytic_code_name_budget1,
                                    'parent_analytic_code_name_budget2' : parent_analytic_code_name_budget2,
