...
#            
            initial_date = (datetime.datetime.strptime(ctx['date_to'],"%Y-%m-%d")-datetime.timedelta(days=30)).strftime("%Y-%m-%d")
            ...
            result_initial_date = (datetime.datetime.today()-datetime.timedelta(days=30)).strftime("%d-%b-%y")
            initial_date = (datetime.datetime.today()-datetime.timedelta(days=30)).strftime("%Y-%m-%d")
        print "*******************************************", initial_date
