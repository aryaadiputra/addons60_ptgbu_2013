...
report_sxw.report_sxw('report.account.print.ad.journal.entries', 'account.journal.period', 'addons/ad_account_optimization/report/account_move_line_record.rml', parser=journal_print, header=False)
report_sxw.report_sxw('report.account.print.ad.journal.entriesh', 'account.journal.period', 'addons/ad_account_optimization/report/account_move_line_record_h.rml', parser=journal_print, header=False)
