...
class wiz_validate_budget_structure(wizard.interface):
    ...
    def _show_result(self, cr, uid, data, context):
        ...
        budget_item_object = pool.get('ad_budget.item')
    ...
    def _get_linked_accounts(self, cr, uid, item_ids, sql_filters, context={}):
        ...
        query = """SELECT aa.id
                   FROM ad_budget_item_account_rel bh, account_account aa
...
wiz_validate_budget_structure('ad_budget.validate_budget_structure');    
