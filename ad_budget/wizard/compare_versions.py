...
class wiz_compare_versions(wizard.interface):
    ...
    _fields = {
        'version_1': {'string':'Version 1', 'type':'many2one', 'relation':'ad_budget.version', 'required':True },
        'version_2': {'string':'Version 2', 'type':'many2one', 'relation':'ad_budget.version', 'required':True },
    ...
    states = {
        ...
        'print' : {
            ...
            'result' : {'type':'print', 'report':'compare_versions2', 'get_id_from_action':True, 'state':'end'},
        },

    }
    
    
wiz_compare_versions('compare.budget.versions2')