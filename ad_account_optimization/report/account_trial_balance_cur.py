...
class account_balance(report_sxw.rml_parse, common_report_header):
    _name = 'report.account.trial.balance.pt.cur'
...
report_sxw.report_sxw('report.account.trial.balance.pt.cur', 'account.account', 'addons/ad_account_optimization/report/account_trial_balance_pt_currency.rml', parser=account_balance, header="internal")