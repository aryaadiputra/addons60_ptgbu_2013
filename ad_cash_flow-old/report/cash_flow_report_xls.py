...
#        
        ...
        tittle_style3 = xlwt.easyxf('font: height 240, name Times New Romance, colour_index black, bold off; ')
        ...
        normal_style = xlwt.easyxf('font: height 200, name Times New Romance, colour_index black, bold off;')
