...
class ad_budget_wizard_abstraction(osv.osv):
    ...
    _name = "ad_budget.wizard_abstraction"
    ...
    def budget_vs_real_get_fields(self, cr, uid, data, context={}):
        ...
        fields['split_by_dept'] = {
                            'string':'Split by Department', 
                            'type':'boolean',
                            'default':lambda *a:False,
                            'help':'Check this to split the report by Department'
                            }        
        fields['split_by_aa'] = {
                            'string':'Split by Analytic Accounts', 
                            'type':'boolean',
                            'default':lambda *a:False,
                            'help':'Check this to split the report by Analytic Account'
                            }        
        return fields
    ...
    def advanced_search_get_fields(self, cr, uid, data, context={}):
        ...
        fields['versions'] = {
                                'string':'Versions', 
                                'type':'many2many', 
                                'relation':'ad_budget.version'
                            }
        return fields

    
ad_budget_wizard_abstraction()