    ...
    def generate_xls_report(self, parser, data, obj, wb):
        ...
        cols_specs = [
                ...
                ('Label Parent Account', 1, 0, 'text',
                    lambda x, d, p: 'Parent Account'),
                ('Label Actual Amount', 1, 0, 'text',
                    lambda x, d, p: 'Actual Amount'),
                ('Label Process Date', 1, 0, 'text',
                    lambda x, d, p: 'Process Date'),
                ('Label Budget Amount', 1, 0, 'text',
                    lambda x, d, p: 'Budget Amount'),
                ...
                ('Label Category', 1, 0, 'text',
                    lambda x, d, p: 'Category'),
                ('Label Parent Category', 1, 0, 'text',
                    lambda x, d, p: 'Parent Category'),
                ('Label Create Date', 1, 0, 'text',
                    lambda x, d, p: 'Create Date'),
                ('Label Current Amount', 1, 0, 'text',
                    lambda x, d, p: 'Current Amount'),
                ...
                ('Label DigitCOA', 1, 0, 'text',
                    lambda x, d, p: 'Digit-1 COA'),
                ('Label Analytic Code Name', 1, 0, 'text',
                    lambda x, d, p: 'Analytic Account Code + Name'),
                ('Label Parent Analytic Code Name', 1, 0, 'text',
                    lambda x, d, p: 'Parent Analytic Account Code + Name'),
                ('Label DigitAnalytic', 1, 0, 'text',
                    lambda x, d, p: 'Digit-1 Analytic'),
                ('Label Get Period', 1, 0, 'text',
                    lambda x, d, p: 'Periods'),
                #####################################
...
#        
        ...
        for budget_line in parser._get_budget_line(data):
            account_budget             = budget_line.budget_item_id.code +" - "+budget_line.budget_item_id.name
